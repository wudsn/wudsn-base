...
public final class Application {
	...
	public final class MemoryInfo {
		 ...
		 * 
		 * @return The maximum amount of memory reserved for Java in MB, not empty, not
		 *         <code>null</code>.
		 */
	...
	/**
	 * Asynchronously checks for an update and display a notification dialog if an
	 * update is available.
	 * 
	 * @param exitForUpdateRunnable
	 *            Callback when the user as selected to download the update and the
	 *            application should exit, so it can be replaced. Can be
	 *            <code>null</code>.
	 */
