...
public final class AttributeTable extends JTable {
	 ...
	 *            The attributeTablePreferences to initialize the column state from
	 *            and to save the column state to, or <code>null</code>.
	 * @param prefix
	 *            The attributeTablePreferences prefix, not <code>null</code>.
	 */
	public AttributeTable(AttributeTableModel model, AttributeTablePreferences attributeTablePreferences,
			String prefix) {
		super();
		if (model == null) {
