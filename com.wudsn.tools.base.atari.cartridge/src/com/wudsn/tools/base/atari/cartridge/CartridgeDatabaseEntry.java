...
public final class CartridgeDatabaseEntry {
	...
	public static final class Key implements Comparable<Key> {
		...
		public String toString() {
			return "sizeInKB=" + sizeInKB + " crc32=0x" + HexUtility.getLongValueHexString(crc32, 8);
		}
	}
	...
	CartridgeDatabaseEntry(int sizeInKB, long crc32, String md5, String title, String publisher, String date,
			CartridgeType cartridgeType, String source) {
		if (sizeInKB < 0) {
			throw new IllegalArgumentException(
					"Parameter 'sizeInK' must not be negative. Specified value is " + sizeInKB + ".");
		}
		if (md5 == null) {
	...
	@Override
	public String toString() {
		return "sizeInKB=" + sizeInKB + " crc32=" + getCRC32HexString() + " md5=" + md5HexString + " title=" + title
				+ " cartridgeType=" + cartridgeType.getId() + " source=" + source;
	}
